...
const passwordResetRedirectUrl = "https://admin.sinbadshop.com/update-password";
...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage("If that admin account exists, a password reset email has been sent.");
  }
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-panel px-6">
      <section className="w-full max-w-md rounded-lg border border-line bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-ink">Reset Admin Password</h1>
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Enter your Sinbad admin email and we will send a secure reset link.
        </p>
